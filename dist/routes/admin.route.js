...
class AdminAuthRoute {
    ...
    initializeRoutes() {
        ...
        this.router.get(`${this.path}department`, adminAuth_middleware_1.default, this.departmentController.getDepartments);
        this.router.get(`${this.path}department/:id`, adminAuth_middleware_1.default, this.departmentController.getDepartmentById);
        this.router.post(`${this.path}department`, (0, validation_middleware_1.default)(department_dto_1.CreateDepartmentDto, 'body'), adminAuth_middleware_1.default, this.departmentController.createDepartment);
        this.router.put(`${this.path}department/:id`, (0, validation_middleware_1.default)(department_dto_1.CreateDepartmentDto, 'body', true), adminAuth_middleware_1.default, this.departmentController.updateDepartment);
        this.router.delete(`${this.path}department/:id`, adminAuth_middleware_1.default, this.departmentController.deleteDepartment);
